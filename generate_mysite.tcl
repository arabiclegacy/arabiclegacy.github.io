...
set include_pages [list \
	00_home/page_home.html    site_contents/00_home/content_home.html   home_list_attr \
]
...
set home_list_attr {
    <a href="../PATH_TO_REF#root" onclick="w3_close()" class="w3-bar-item w3-button w3-right w3-padding w3-text-teal"><i class="fa fa-home fa-fw w3-margin-left w3-right"></i><div class="w3-right-align">صفحة البداية</div> </a> 
...
set CreatedFile [ open site_pages/${TargetFile} w+ ]
...
<!-- Sidebar/menu -->
<nav class="w3-sidebar w3-collapse w3-white w3-animate-right" style="z-index:3;width:250px;right:0" id="mySidebar"><br>
